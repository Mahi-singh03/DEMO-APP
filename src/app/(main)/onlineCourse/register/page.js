...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateForm()) {
      ...
      document.getElementById('error-message')?.classList.add('animate-shake');
      setTimeout(() => {
        document.getElementById('error-message')?.classList.remove('animate-shake');
      }, 1000);
  ...
  return (
    <div className="min-h-screen bg-[#e3f1f1] flex items-center justify-center p-4">
      <div className="w-full max-w-px-600 bg-[#f9f9f9] rounded-2xl shadow-lg p-60 sm:p-10">
        <div className="text-center mb-8">
          <h1 className="text-center text-4xl sm:text-5xl font-bold text-[#1e90ff]">Course Registration</h1>
        </div>

        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-8">
            {error && (
              <div id="error-message" className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start">
                <svg
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div key={field} className="animate-fadeIn" style={{ animationDelay: `${index * 0.1}s` }} data-error={!!fieldErrors[field]}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={handleBlur}
                      className={`pl-10 mt-1 block w-full px-4 py-3 border ${fieldErrors[field] ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition duration-150 ease-in-out`}
                      placeholder={
              ...
              <div className="animate-fadeIn" style={{ animationDelay: '0.4s' }} data-error={!!fieldErrors.courseSelected}>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={`pl-10 mt-1 block w-full px-4 py-3 border ${fieldErrors.courseSelected ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition duration-150 ease-in-out appearance-none`}
                  >
                ...
                {fieldErrors.courseSelected && (
                  <p className="mt-1 text-sm text-red-600">{fieldErrors.courseSelected}</p>
                )}
              </div>
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150 ${isSubmitting ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'}`}
                >
                  {isSubmitting ? (
                    <>
                      <svg
